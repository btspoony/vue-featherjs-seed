...
var baseConfig = require('../../../bin/webpack.base.conf'){{#if_eq lintConfig "airbnb"}};{{/if_eq}}
var utils = require('../../../bin/utils'){{#if_eq lintConfig "airbnb"}};{{/if_eq}}
var webpack = require('webpack'){{#if_eq lintConfig "airbnb"}};{{/if_eq}}
var projectRoot = utils.resolveFrontendPath(''){{#if_eq lintConfig "airbnb"}};{{/if_eq}}
...
var webpackConfig = merge(baseConfig, {
  ...
  plugins: [
    new webpack.DefinePlugin({
      'process.env': require('../../../bin/config/test.env')
    })
  ]
